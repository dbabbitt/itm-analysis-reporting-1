...
# Configuration file for lab. Copy to C:\Users\DaveBabbitt\.jupyter\jupyter_lab_config.py.
# 
# Run this in from a command line:
# jupyter lab --no-browser --config=C:\Users\DaveBabbitt\.jupyter\jupyter_lab_config.py --notebook-dir=C:\Users\DaveBabbitt\Documents\GitHub --app-dir=C:\Users\DaveBabbitt\anaconda3\share\jupyter\lab
# 
# or, from a PowerShell script:
# $ScriptsDirectory = "${Env:UserProfile}\anaconda3\Scripts"
# $FilePath = "${ScriptsDirectory}\jupyter.exe"
# $ConfigArg = "${Env:UserProfile}\.jupyter\jupyter_lab_config.py"
# $NotebookArg = "${Env:UserProfile}\Documents\GitHub"
# $AppArg = "${Env:UserProfile}\anaconda3\share\jupyter\lab"
# $ArgumentList = "lab --no-browser --config=${ConfigArg} --notebook-dir=${NotebookArg} --app-dir=${AppArg}"
# Start-Process -FilePath $FilePath -ArgumentList $ArgumentList -PassThru
# 
# or, from a bash script:
# ScriptsDirectory="$HOME/anaconda3/Scripts"
# FilePath="$ScriptsDirectory/jupyter.exe"
# ConfigArg="$HOME/.jupyter/jupyter_lab_config.py"
# NotebookArg="$HOME/Documents/GitHub"
# AppArg="$HOME/anaconda3/share/jupyter/lab"
# ArgumentList="lab --no-browser --config=$ConfigArg --notebook-dir=$NotebookArg --app-dir=$AppArg"
# gnome-terminal -- "$FilePath" $ArgumentList
...
repo_dir = osp.join(home_dir, 'Documents', 'GitHub')
if 'CONDA_PREFIX' in environ_dict: anaconda_dir = environ_dict['CONDA_PREFIX']
else: anaconda_dir = osp.join(home_dir, 'anaconda3')
...
## Base class for configurable Jupyter Server       ##
## Extension Applications.                          ##
## ExtensionApp subclasses can be initialized two   ##
## ways:                                            ##
##   1. Extension is listed as a                    ##
##     jpserver_extension, and ServerApp calls      ##
##     its load_jupyter_server_extension            ##
##     classmethod. This is the classic way of      ##
##     loading a server extension.                  ##
##   2. Extension is launched directly by calling   ##
##     its `launch_instance` class method.          ##
##     This method can be set as a entry_point in   ##
...
## A Lab Server Application that runs out-of-the-   ##
## box                                              ##
######################################################
...
#  Default: 'C:\\Users\\DaveBabbitt\\.jupyter\\lab\\user-settings'
# c.LabApp.user_settings_dir = 'C:\\Users\\DaveBabbitt\\.jupyter\\lab\\user-settings'
...
#  Default: 'C:\\Users\\DaveBabbitt\\.jupyter\\lab\\workspaces'
# c.LabApp.workspaces_dir = 'C:\\Users\\DaveBabbitt\\.jupyter\\lab\\workspaces'
