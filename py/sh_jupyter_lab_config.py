...
# Configuration file for lab. Copy to \\wsl.localhost\Ubuntu\home\dbabbitt\.jupyter\jupyter_lab_config.py.
# 
# Run this in from a command line:
# jupyter lab --config=/home/dbabbitt/.jupyter/jupyter_lab_config.py --notebook-dir=/mnt/c/Users/DaveBabbitt/Documents/GitHub --app-dir=/home/dbabbitt/anaconda3/share/jupyter/lab

# Make sure that the path to your repositories and anaconda installation is correct
import os
import os.path as osp
environ_dict = dict(os.environ)
if 'USERPROFILE' in environ_dict: home_dir = environ_dict['USERPROFILE']
else: home_dir = osp.join('home', 'dbabbitt')
repo_dir = osp.join('mnt', 'c', 'Users', 'DaveBabbitt', 'Documents', 'GitHub')
...
#  Default: '/home/dbabbitt/.jupyter/lab/user-settings'
# c.LabApp.user_settings_dir = '/home/dbabbitt/.jupyter/lab/user-settings'
...
#  Default: '/home/dbabbitt/.jupyter/lab/workspaces'
# c.LabApp.workspaces_dir = '/home/dbabbitt/.jupyter/lab/workspaces'
...
## Manages a single kernel in a subprocess on this  ##
## host.                                            ##
######################################################

## Start the python kernel with the -Xfrozen_modules=off flag
# Debugging will proceed. Set PYDEVD_DISABLE_FILE_VALIDATION=1 to disable this validation.
c.KernelManager.kernel_cmd = ['python', '-Xfrozen_modules=off', '{connection_file}']